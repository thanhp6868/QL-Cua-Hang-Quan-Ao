                            ...
                            <div class="row g-0">
                                <div class="col-xl-12 bg-grey">
                                    <div class="p-5">
                                        ...
                                        <div>
                                            <input type="radio" name="test" value="Cash on delivery"
                                                alt="Cash on delivery" checked onclick="ErrorSolve()">
                                            <label for="Cash on delivery">Thanh toán khi nhận hàng</label><br>
                                            <input type="radio" id="bank" name="test" value="bank" checked
                                                onclick="ErrorMessage()">
                                            <label for="bank">Chuyển khoản</label><br>
                                            <input type="radio" id="Momo" name="test" value="Momo" checked
                                                onclick="ErrorMessage()">
                                        ...
                                        <br>
                                        <a href="confirm_order.php?data=<?php echo $total . "/" . $row_count ?>"
                                            id="con_btn"><button class="btn btn-primary disabled" role="button"
                                                aria-disabled="true">Xác nhận đặt hàng</button></a>
