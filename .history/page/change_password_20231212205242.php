                                ...
                                <div class="otp_send_form">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-outline mb-5">
                                            <input type="password" name="new_pass" placeholder="Mật khẩu mới" class="form-control form-control-lg" style="width:30rem !important" required />
                                        </div>
                                        <div class="form-outline mb-5">
                                            <input type="password" name="con_pass" placeholder="Nhập lại mật khẩu" class="form-control form-control-lg" style="width:30rem !important" required />
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" name="submit" style="background: #f3c6f7;" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Đổi mật khẩu</button>
                                        </div>
                                    </form>
                                </div>
