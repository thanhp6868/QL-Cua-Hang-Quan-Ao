...
<head>
  ...
  <title>HRX | Quên mẹ mật khẩu</title>
</head>
                ...
                <div class="otp_send_form">
                  ...
                  <form action="" method="post">
                    <div class="form-outline mb-5">
                      <input type="email" id="email" name="email" placeholder="Email" class="form-control form-control-lg" style="width:30rem !important" required />
                    </div>
                    <div class="d-flex justify-content-center">
                      <button type="submit" name="submit" style="background: #f3c6f7;" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Lấy mã OTP</button>
                    </div>
                  </form>
                </div>
