            ...
            <div class="card-body p-0">
              <div class="row g-0">
                ...
                <div class="col-lg-4 bg-grey">
                  <div class="p-5">
                    <h3 class="fw-bold mb-5 mt-2 pt-1">T</h3>
                    <hr class="my-4">
                    ...
                    <div class="mb-4 pb-2">
                      <form action="" method="post">
                        <select class="select" name="tax" style="margin-bottom: 5px !important">
                          ...
                          <option value="50">Tiêu chuẩn(4-5 ngày)- 15.000 VNĐ</option>
                          <option value="100">Nhanh(3-4 ngày)- 30.000 VNĐ</option>
                          <option value="100">Hoả tốc(1 ngày)- 50.000 VNĐ</option>
                        </select>
