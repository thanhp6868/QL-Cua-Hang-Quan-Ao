...
<body>
    ...
    <header>
        ...
        <form action="Men/search_products.php" method="post"><input class="search" type="search" name="search_key" id="" placeholder="Tìm kiếm sản phẩm"></form>
                            ...
                            <div class="row g-0">
                                <div class="col-xl-12 bg-grey">
                                    <div class="p-5">
                                        ...
                                        <h3 style="color: #d42c2c;">Hiện không khả dụng</h3>
