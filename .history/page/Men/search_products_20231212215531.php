...
<body>
    <header>
        ...
        <form action="search_products.php" method="post"><input class="search" type="search" name="search_key" id="" placeholder="Tìm kiếm sản phẩm"></form>
    ...
    <div>
        <h3 class="link_w"> <a href="../../index.php">Home /</a> <small>Tìm kiếm: <?php echo $key_search?></small> </h3>
        <div class="p_show">
