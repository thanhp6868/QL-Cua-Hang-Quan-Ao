...
<body>
  ...
  <div class="details">
    ...
    <h2 class="detailsy">
      <?php echo number_format($p_price, 0, ',', '.') . ' VNĐ' ?>
      <del>
        <?php
    ...
    <?php
    if ($p_quantity > 0)
    echo '<a href="../../add_to_cart.php?add_to_cart='.$p_id . '/' . $p_price.'"><button class="addbagb">Thêm
    vào giỏ hàng</button></a>';
  
    else 
    echo '<a href=""><button class="addbagb">Hết hàng</button></a>';
  ...
  <div class="productsdetails">
    ...
    <h3>100 % Cotton co giãn hai chiều, vip</h3>
