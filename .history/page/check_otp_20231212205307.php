                                ...
                                <div class="otp_send_form">
                                    ...
                                    <form action="" method="post">
                                        <div class="form-outline mb-5">
                                            <input type="text" name="otp" placeholder="Nhập OTP" class="form-control form-control-lg" style="width:30rem !important" required />
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" name="submit" style="background: #f3c6f7;" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Xác nhận</button>
                                        </div>
                                    </form>
                                </div>
