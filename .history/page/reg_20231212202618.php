              ...
              <div class="card-body p-5">
                ...
                <form action="../backend/user_reg.php" method="post">
                  ...
                  <div class="form-outline mb-3">
                    <input type="text" id="name" placeholder="Tên" name="name" class="form-control form-control-lg" />
                  ...
                  <div class="form-outline mb-3">
                    <input type="password" placeholder="Nhập lại mật khẩu" id="cpassword" name="cpassword" class="form-control form-control-lg" />
                  ...
                  <div class="form-outline mb-3">
                    <input type="text" placeholder="Địa chỉ" id="address" name="address" class="form-control form-control-lg" />

                  </div>
                  <div class="form-outline mb-3">
                    <input type="text" placeholder="Địa chỉ dự phòng" id="address2" name="address2" class="form-control form-control-lg" />

                  </div>
                  <div class="form-outline mb-3">
                    <input type="text" placeholder="Số điện thoại" id="number" name="number" class="form-control form-control-lg" />

                  </div>
                  <div class="form-check d-flex justify-content-center mb-5">
                    <input class="form-check-input me-2" type="checkbox" value="" id="form2Example3cg" />
                    <label class="form-check-label" for="form2Example3g">
                     Tôi đồng ý với các<a href="terms.php" class="text-body"><u> điều khoản</u></a>
                    </label>
                  </div>

                  <div class="d-flex justify-content-center">
                    <button type="submit" style="background: rgb(145,230,247);
background: linear-gradient(90deg, rgba(145,230,247,1) 0%, rgba(210,167,236,1) 100%);" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="Register">Đăng ký</button>
                  </div>

                  <p class="text-center text-muted mt-5 mb-0">Có tài khoản?<a href="../index.php" class="fw-bold text-body"><u> Đăng nhập ngay</u></a></p>
