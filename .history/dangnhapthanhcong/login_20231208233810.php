...
<body>
    <div id="wrapper">
        <div id="top">
            ...
            <div id="top-right">
                <ul>
                    <li><a href="#"><img src="products/login.png"
                                style="position:absolute; right: 196px;top:11px;" /></a></li>
                    <li>|</li>
        ...
        <div id="logo">
            ...
            <div id="logo-right2">
                <div>
                    <form id="timkiem"><input id="text-form" type="text" name="timkiem" placeholder="Tìm kiếm sản phẩm"
            ...
            <div id="logo-right3">
                <div>
                    <div id="anh"><img src="products/call2.png" /></div>SUPPORT : 0979433225
                </div>
            </div>
        </div>
        <div id="menu">
            <ul>
                <li><img src="products/home.png" width="40px" height="40px"
        ...
        <div id="footer">
            ...
            <div class="bottom" id="footer-right">
                ...
                <ul>
                    <li>
                        <h3>Copyright © 2016 Fanshop.vn</h3>
                    </li>
                    <li><a href="#">Địa chỉ: Tòa nhà FPT Tân Thuận, Lô 29B-31B-33B, Đường Tân Thuận, KCX Tân Thuận,
