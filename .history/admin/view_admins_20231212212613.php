...
<head>
    ...
    <title>HRX | Admin | Sản phẩm</title>
        ...
        <div class="text-2">
            ...
            <div class="d-flex justify-content-center mb-2">
                ...
                if ($res) {
                    ...
                    if ($admin_type == "main") {
                        echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border:none !important">Thêm admin</button>';
                    }
                } else {
                    ...
                    <div class="form-popup" id="myForm">
                        ...
                        <form action="add_admin.php" class="form-container" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Tên" name="admin_name" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Số điện thoại" name="admin_phone" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button class="btn btn-warning" type="submit" name="update">Thêm admin</button>
                            </div>
