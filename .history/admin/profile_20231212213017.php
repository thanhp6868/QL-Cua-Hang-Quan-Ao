                        ...
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border:none !important"><i class='bx bxs-edit' style='color:#ffffff'></i> Chỉnh sửa</button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Sửa profile</h1>
                    ...
                    <div class="form-popup" id="myForm">
                        <form action="update_profile.php" class="form-container" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Tên" name="name" value="<?php echo $name; ?>" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Số điện thoại" name="mobile" value="<?php echo $mobile; ?>" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button class="btn btn-warning" type="submit" name="update">Cập nhật</button>
                            </div>
