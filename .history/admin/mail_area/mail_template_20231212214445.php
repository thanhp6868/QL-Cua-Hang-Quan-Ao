																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<strong><span style="font-size:38px;">quên
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
																			<span style="font-size:16px;">Chúng tôi nhận
																				được yêu cầu cấp lại mật khẩu</span>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
																			<span style="font-size:16px;">Mã OTP:
																			</span>
																		</p>
																	</div>
																</div>
														...
														<tr>
															<td class="pad"
																...
																<div align="left" class="alignment">
																	<p>
																		<span
																			style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;">
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #f5eeee; width: 600px;"
										width="600">
										<tbody>
											<tr>
												<td class="column column-1"
