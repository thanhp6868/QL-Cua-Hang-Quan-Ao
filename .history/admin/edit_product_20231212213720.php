        ...
        <ul class="nav-list">
            ...
            <li>
                <a href="view_orders.php">
                    ...
                    <span class="links_name">Đơn hàng chờ xử lý</span>
                </a>
    ...
    <section class="home-section">
        ...
        <div class="edit">
            ...
            <section class="edit_section">
                ...
                <div class="edit_form">
                    ...
                    <form action="update_product.php" class="form-container" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-1">
                            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Tên sản phẩm" name="p_name" value="<?php echo $p_name ?>" required>
                        </div>
                        ...
                        <div class="input-group mb-1">
                            <textarea class="form-control" aria-label="With textarea" placeholder="Mô tả" name="p_details" required><?php echo $p_details ?></textarea>
                        </div>
                        <!-- <div class="form-outline mb-1">
                        ...
                        <div class="form-outline mb-1">
                            <input type="number" placeholder="Giá (VNĐ)" id="price" name="p_price" class="form-control form-control-m" value="<?php echo $p_price ?>" />
                        </div>

                        <div class="form-outline mb-1">
                            <input type="number" placeholder="Số lượng" id="quantity" name="p_quantity" class="form-control form-control-m" value="<?php echo $p_quantity ?>" />



                        </div>
                        <div class="form-outline mb-1">
                            <input type="text" placeholder="Từ khoá" id="" name="p_keyword" class="form-control form-control-m" value="<?php echo $p_keyword ?>" />
                ...
                <script>
                    function Message() {
                        return confirm("Lưu các thay đổi?");
                    }
                </script>
