                        ...
                        <form action="add_product.php" class="form-container" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" id="inputGroupSelect01" name="p_sub_ctag">
                                    <option selected>Choose...</option>
                                    <option value="Topwear" style="background-color: #333454;color: aliceblue;">Đồ thể thao vip</option>
                                    ...
                                    <option value="Western wear" style="background-color:#59343e ;color: aliceblue;">Giầy vip</option>
