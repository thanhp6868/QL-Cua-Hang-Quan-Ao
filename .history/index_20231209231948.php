        ...
        <form action="" method="get">
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="page/Men/topware.php?ctg=Men/Sports and Active wear" name="ctg">Đồ thể thao vip</a>
              <a href="page/Men/topware.php?ctg=Men/Topwear" name="ctg">Áo khoác vip</a>
              <a href="page/Men/topware.php?ctg=Men/Bottomwear" name="ctg">Quần vip</a>
              <a href="page/Men/topware.php?ctg=Men/Festive wear" name="ctg">Quần áo vip</a>

              <a href="page/Men/topware.php?ctg=Men/Footwear" name="ctg">Giầy vip</a>
              <a href="page/Men/topware.php?ctg=Men/Accessories" name="ctg">Phụ kiện vip</a>
            </div>
          </div>
          <div class="dropdown">
